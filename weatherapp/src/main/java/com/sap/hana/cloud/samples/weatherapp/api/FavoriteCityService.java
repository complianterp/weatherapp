...
public class FavoriteCityService 
{
	...
	@GET
	@Path("/{id}")
	public FavoriteCity getFavoriteCity(@Context SecurityContext ctx, @PathParam(value = "id") String id)
	{
	...
	@POST
	@Path("/")
	public List<FavoriteCity> addFavoriteCity(@Context SecurityContext ctx, FavoriteCity city)
	{
		List<FavoriteCity> retVal = null;
